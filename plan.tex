...
\section{PLAN DE INVESTIGACIÓN}
    ...
    Partiendo de esta problemática nace Fog Computing \citep{yi2015} , una solución que viene de una u otra manera  a lidiar con la latencia que se presenta en la entrega de los datos, planteando un arquitectura distribuida y más local al lugar donde se generan los datos; además de eso Fog Computing lanza la idea de aprovechar la capacidad de cómputo de los dispositivos finales, pero es ahí donde tenemos un nuevo problema, estos dispositivos cuentan con recursos limitados; recursos que son accesibles en cuestiones económicas debido al auge y el crecimiento de IoT pero con limitaciones en su nivel de procesamiento y almacenamiento.\par
    Sin embargo la informática paralela ha surgido en las últimas décadas, y sus técnicas pueden adecuarse al IoT para resolver los problemas mencionados anteriormente \citep{piccialli2018}.\par
    ...
    \subsection{Hipótesis}
        El uso de de algoritmos paralelos sobre la arquitectura Fog Computing reducirá la latencia en IoT.\par
    \newpage
    ...
    \subsection{Objetivos}
        \subsubsection{Objetivo general}
            Diseñar algoritmos paralelos sobre la arquitectura Fog Computing para reducir la latencia en IoT.
        \subsubsection{Objetivos específicos}
            \begin{enumerate}
                ...
                \item[c)] Comprobar que los algoritmos paralelos permiten disminuir la latencia.
                \item[d)] Analizar los resultados obtenidos de la investigación.
                \item[e)] Validar los resultados.
            \end{enumerate}
    \subsection{Método de trabajo}    
            ...
            \subsubsection{Población y muestra}    
                \vskip 0.3cm
                \begin{enumerate}
                    \item[]{{\bf Universo:} Transmisiones de datos en IoT.}
            ...
            \subsubsection{Etapas}
                ...
                \begin{enumerate}
                    ...
                    \item[i)] Análisis de los resultados obtenidos. 
                \end{enumerate}                
