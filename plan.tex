...
\section{PLAN DE INVESTIGACIÓN}
    ...
    \subsection{Método de trabajo}    
            \subsubsection{Universo, Población, Muestra y Unidad de estudio:}
                {\bf Universo:} Dispositivos IoT del perú.\par
                {\bf Población:} Dispositivos IoT en la agricultura.\par
                {\bf Muestra:} Dispositivos IoT en cosechas de arroz.\par
                {\bf Unidad de estudio:} Dispositivo IoT.
