...
\section{PLAN DE INVESTIGACIÓN}
    \subsection{Antecedentes y fundamentación científica, técnica o humanística}
        ...
        Este paper nos brinda resultados esperados en cuanto a, simulando el uso de la arquitectura Fog Computing con el software iFogSim.\par
        \vskip 0.3cm
        ...
        Y para culminar concluimos que dicha investigación nos aporta el gran poder que tiene Fog Computing frente a temas de latencia y su manera eficiente de como solucionarlo, además nos muestran un panorama donde la combinación entre Fog Computing y el algoritmo de equilibrio de carga logran ser un dupla perfecta frente a estos problemas.\par
        \vskip 0.3cm
        ...
        Este paper nos indica los campos necesarios a investigar para lidiar con grandes volúmenes de datos, tales como: arquitecturas híbridas, problemas de datos masivos, herramientas existentes para resolver problemas de datos masivos entre otros, etc.\par
        \vskip 0.3cm
    ...
    \subsection{Problema}
        ...
        El escenario antes mencionado nos enfrenta al problema de ¿De qué manera se podría reducir la elevada latencia generada por las constantes peticiones desde los dispositivos iot al servidor?\par
    ...
    \subsection{Método de trabajo}    
            \subsubsection{Universo, Población, Muestra y Unidad de estudio:}
                {\bf Universo:} Transmisiones de datos en Internet.\par
                {\bf Población:} Transmisiones de datos del Internet de las Cosas.\par
                {\bf Muestra:} Transmisiones de datos del Internet de las Cosas, Z=1,64 - 94\% , S=1s, E=0.5s, n=10.7584 .\par
                {\bf Unidad de estudio:} Transmision de los datos(paquetes) de IoT donde se manejan grandes cantidades de información.
            \subsubsection{Etapas:}
                \begin{enumerate}
                    \item[a)] Analisis de los principales problemas con respecto a la transmisión de datos a los que se enfrenta actualmente IoT y a los que va enfrentar en un futuro cercano.
                    ...
                    \item[d)] Levantamiento biliográfico de los diferentes temas necesarios para la elaboración de la investigación, tales como IoT, Cloud Comptuing, Fog Computing, la computación paralela, entre otros.
                    ...
                    \item[f)] Estudio y análisis de los diferentes métodos de solución evaluados en la revisión bilbiográfica, así como los que serán propuestos en este estudio.
                    ...
                    \item[k)] Levantamiento de los datos necesarios para validar y testar la propuesta desarrollada.
                    \item[l)] Levantamiento de simulación de datos para ejecutar la propuesta.
                    \item[m)] Testes y validación de la propuesta desarrollada en área industrial escogida. 
                \end{enumerate}                
